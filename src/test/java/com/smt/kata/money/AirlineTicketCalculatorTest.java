...
/****************************************************************************
 * <b>Title</b>: AirlineTicketCalculatorTest.java <b>Project</b>: SMT-Kata
...
class AirlineTicketCalculatorTest {
	...
	/**
	 * Test method for
	 * {@link com.smt.kata.money.AirlineTicketCalculator#findCheapest(java.util.List)}.
	 */
	@Test
	...
	void testFindCheapestInvalidConnections() throws Exception {
		...
		assertEquals(500, atc.findCheapest(flights, "JFK", "LAX", 25));
	}
