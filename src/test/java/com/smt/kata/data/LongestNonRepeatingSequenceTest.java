...
/****************************************************************************
 * <b>Title</b>: LongestNonRepeatingSequenceTest.java <b>Project</b>: SMT-Kata
...
class LongestNonRepeatingSequenceTest {
	...
	/**
	 * Test method for
	 * {@link com.smt.kata.data.LongestNonRepeatingSequence#find(java.lang.String)}.
	 */
	@Test
	...
	void testFindLong() throws Exception {
		assertEquals(9, lnrcs.find("This is the end of the world as we know it"));
	}
}
