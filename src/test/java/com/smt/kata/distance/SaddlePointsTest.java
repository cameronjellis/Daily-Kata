...
/****************************************************************************
 * <b>Title:</b> SaddlePointsTest.java <b>Project:</b> SMT-Kata
 * <b>Description:</b> Unit Test for the Saddle Points Kata <b>Copyright:</b>
 * Copyright (c) 2021 <b>Company:</b> Silicon Mountain Technologies
 * 
 * @author James Camire
 * @version 3.0
...
class SaddlePointsTest {
	...
	@BeforeAll
	static void init() {
		threeByThreeMatrix = new int[][] { { 9, 8, 7 }, { 5, 3, 2 }, { 6, 6, 7 } };

		threeByFourMatrix = new int[][] { { 5, 2, 2, 5 }, { 6, 6, 7, 8 }, { 7, 1, 4, 6 } };
	}

	/**
	 * Test method for
	 * {@link com.smt.kata.distance.SaddlePoints#SaddlePoints(int[][])}.
	 */
	@Test
