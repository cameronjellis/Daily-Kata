...
/****************************************************************************
 * <b>Title</b>: TrianglePath.java <b>Project</b>: SMT-Kata <b>Description: </b>
 * Triangle Path Kata
 * 
 * Triangle
 ...
 * sum from top to bottom is 2 + 3 + 5 + 1 = 11.
 * 
 * Example 2: Input: triangle = [[-10]] Output: -10
 * 
 * Constraints: 1 <= triangle.length <= 200 triangle[0].length == 1
 * triangle[i].length == triangle[i - 1].length + 1 -104 <= triangle[i][j] <=
 * 104
 * 
...
public class TrianglePath {
	...
	public int smallest(int index, int[] row) {
